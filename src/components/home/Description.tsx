      ...
      entreprise ? (
        <section>
          <div className="container px-2 py-10 flex flex-col md:flex-row gap-8 items-stretch">
            ...
            <ImageDisplay image={entreprise.images[0].directus_files_id} wrapperClasses="shadow-lg w-full flex-1 rounded-lg overflow-hidden relative" classes="rounded-lg"/>
          </div>
        </section>
